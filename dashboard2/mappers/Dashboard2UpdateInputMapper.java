...
public class Dashboard2UpdateInputMapper implements InputModelMapper<Dashboard2UpdateInput, Dashboard2, Urn> {
    public static final Dashboard2UpdateInputMapper INSTANCE = new DashboardUpdateInputMapper();
    ...
    @Override
    public Dashboard2 apply(@Nonnull final DashboardUpdateInput dashboard2UpdateInput,
                           @Nonnull final Urn actor) {
