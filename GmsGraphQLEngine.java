...
import com.linkedin.datahub.graphql.types.dashboard2.DashboardType;
...
public class GmsGraphQLEngine {
    ...
    private final DashboardType dashboard2Type;
    ...
    public GmsGraphQLEngine(final AnalyticsService analyticsService) {
        ...
        this.dashboard2Type = new DashboardType(GmsClientFactory.getEntitiesClient());
        ...
        this.entityTypes = ImmutableList.of(datasetType, corpUserType, corpGroupType,
                dataPlatformType, chartType, dashboardType, dashboard2Type, tagType, mlModelType, mlModelGroupType, mlFeatureType,
        ...
        builder.type("Query", typeWiring -> typeWiring
                ...
                .dataFetcher("dashboard", new AuthenticatedResolver<>(
                        new LoadableTypeResolver<>(dashboardType,
                                (env) -> env.getArgument(URN_FIELD_NAME))))
                .dataFetcher("dashboard2", new AuthenticatedResolver<>(
                        new LoadableTypeResolver<>(dashboard2Type,
                                (env) -> env.getArgument(URN_FIELD_NAME))))
    ...
    private void configureMutationResolvers(final RuntimeWiring.Builder builder) {
        builder.type("Mutation", typeWiring -> typeWiring
                ...
                .dataFetcher("updateDashboard2", new AuthenticatedResolver<>(new MutableTypeResolver<>(dashboard2Type)))
